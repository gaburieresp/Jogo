...
class Game:
    ...
    def determineWinner(self):
        resultsString = "It's a Draw"

        if self.participant.points > self.secondParticipant.points:
            resultsString = "Winner is {name}".format(name=self.participant.name)
        
        elif self.participant.points < self.secondParticipant.points:
            resultsString = "Winner is {name}".format(name=self.secondParticipant.name)
